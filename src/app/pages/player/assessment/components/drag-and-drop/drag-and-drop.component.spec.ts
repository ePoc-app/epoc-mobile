...
import {DragAndDropquestion, Response} from '../../../../../classes/contents/assessment'
...
describe('DragAndDropComponent', () => {
    ...
    it('should update values depending on correctionState & solutionShown', () => {
        ...
        expect(component.selectValue['A']).toEqual(r1.label);
        expect(component.selectValue['B']).toEqual(r2.label);
        expect(component.selectValue['C']).toEqual(r3.label);
        expect(component.selectValue['D']).toEqual(r4.label);
