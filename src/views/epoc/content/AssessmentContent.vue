...
<template>
    <div class="assessment-specs">
        ...
        <div class="assessment-spec">
            ...
            <div class="assessment-spec-value">
                {{ t('MISSING.QUESTION', questionNumber, { named: { nb: questionNumber } }) }}
            </div>
        </div>
    </div>
    <p>{{ content.summary }}</p>
    <div>
        <ion-button
            ...
            :router-link="{ name: 'AssessmentPage', params: { epoc_id: epoc.id, assessment_id: content.id } }"
        >
